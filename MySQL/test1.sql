...
CREATE TABLE Users (
    id TEXT NOT NULL PRIMARY KEY AUTO_INCREMENT UNIQUE,
...
INSERT INTO User (userid, username, teamid) VALUES ('001','passerby1','clubroom-i
mbibe-compost');
INSERT INTO User (userid, username, teamid) VALUES ('002','passerby2','quondam-chimney-wont');
INSERT INTO User (userid, username, teamid) VALUES ('003','passerby3','silage-croon-lavish');
...
INSERT INTO User (userid, username, teamid) VALUES ('001','passerby1','militia-manteau-twill');
